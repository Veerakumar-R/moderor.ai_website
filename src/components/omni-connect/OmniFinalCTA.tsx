...
import { omniFinalCta } from "@/content/omniConnect";
...
export function OmniFinalCTA() {
  const descriptionLines = Array.isArray(omniFinalCta.description)
    ? omniFinalCta.description
    : [omniFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="omni-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="omni-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{omniFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {omniFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
