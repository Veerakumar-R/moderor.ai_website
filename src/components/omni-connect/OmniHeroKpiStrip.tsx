...
import { omniHero } from "@/content/omniConnect";
...
export function OmniHeroKpiStrip() {
  const { kpiSection, kpis } = omniHero;

  return (
    <div className="aw-hero-kpi-section" aria-label="Omni Connect business outcomes">
