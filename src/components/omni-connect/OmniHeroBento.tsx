...
import { Bot, MoreVertical, Phone, TrendingUp, Users } from "lucide-react";
...
const RECOVERY_RATES = LINE_MONTHS.map((m) => m.rate);
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <div>
            <p className="aw-stack-kicker aw-stack-kicker--accent">Recovery AI</p>
            <p className="aw-stack-sub aw-stack-sub--accent">Drop-off detection</p>
          </div>
        </div>
        <CardMenu />
      </div>
      ...
      <div className="aw-stack-accent-body">
        <div className="aw-stack-ring aw-stack-ring--accent" aria-hidden>
          <svg viewBox="0 0 64 64">
            <defs>
              <linearGradient id="omni-accent-ring-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <div>
            <p className="aw-stack-kicker">Recovered Journeys</p>
            <p className="aw-stack-sub">Across channels</p>
          </div>
        </div>
        <CardMenu />
      </div>
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <div>
            <p className="aw-stack-kicker">Recovery Rate</p>
            <p className="aw-stack-sub">Customer re-engagement</p>
          </div>
        </div>
        <CardMenu />
      </div>
      ...
      <div className="aw-stack-rate-head">
        <p className="aw-stack-metric aw-stack-metric--sm">
          <Count to={RECOVERY_RATES[focus]} decimals={1} />
          <span>%</span>
        </p>
        <div className="aw-stack-rate-stats">
          <span className="aw-stack-rate-pill aw-stack-rate-pill--done">142 recovered</span>
          <span className="aw-stack-rate-pill aw-stack-rate-pill--pending">18 active</span>
        </div>
      </div>
      ...
      <div className="aw-stack-line-wrap aw-stack-line-wrap--rate" aria-hidden>
        <svg className="aw-stack-line-chart" viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="none">
          <defs>
            <linearGradient id="omni-rate-area" x1="0" y1="0" x2="0" y2="1">
...
function MiniStatusCard({ reduceMotion }: { reduceMotion: boolean }) {
  const rows = [
    { id: "OUT-2847", status: "Active", tone: "blue" },
    { id: "OUT-2841", status: "Converted", tone: "grey" },
  ];
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <p className="aw-stack-kicker">Active Outreach</p>
        </div>
        <CardMenu />
      </div>
