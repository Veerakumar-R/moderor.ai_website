...
import { raFinalCta } from "@/content/riskAssessment";
...
export function RaFinalCTA() {
  const descriptionLines = Array.isArray(raFinalCta.description)
    ? raFinalCta.description
    : [raFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="ra-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="ra-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{raFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {raFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
