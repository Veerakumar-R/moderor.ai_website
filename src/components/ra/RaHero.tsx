...
import { RaHeroVisual } from "./RaHeroVisual";
import "./ra.css";
...
export function RaHero() {
  return (
    <section className="aw-hero" aria-labelledby="ra-hero-title">
      <motion.div
        ...
        <div className="aw-hero-body">
          <div className="aw-hero-banner-grid">
            <div className="aw-hero-copy">
              ...
              <h1 id="ra-hero-title" className="aw-hero-title">
                <span className="aw-hero-title-line">{raHero.titleLine1}</span>
                <span className="aw-hero-title-line">{raHero.titleLine2}</span>
              </h1>

              <p className="aw-hero-desc">{raHero.description}</p>

              <div className="aw-hero-cta-row">
                <PillButton href="#ra-capabilities" variant="orange" showArrow>
                  {raHero.primaryCta}
                </PillButton>
                <PillButton
                  href="#ra-capabilities"
                  variant="white"
