...
import { raHero } from "@/content/riskAssessment";
...
export function RaHeroKpiStrip() {
  const { kpiSection, kpis } = raHero;

  return (
    <div className="aw-hero-kpi-section" aria-label="Risk Assessment business outcomes">
