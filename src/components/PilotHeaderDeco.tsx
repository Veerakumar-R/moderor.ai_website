...
function Sparkle({
  ...
  return (
    <motion.div
      className={`pilot-sparkle absolute ${className ?? ""}`}
...
export function PilotHeaderDeco() {
  const reduceMotion = useReducedMotion();

  return (
    <div className="pilot-header-deco" aria-hidden>
      <Sparkle
        className="pilot-sparkle--left"
        gradientId="pilot-sparkle-1"
        from="#ff7a00"
        to="#ffb347"
        delay={0}
      ...
      />
      <Sparkle
        className="pilot-sparkle--right"
        gradientId="pilot-sparkle-2"
        from="#ffb347"
        to="#ff7a00"
        delay={0.55}
        reduceMotion={!!reduceMotion}
