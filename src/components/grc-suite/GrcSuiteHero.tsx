          ...
          <div className="grc-section-inner w-full">
            <div className="grc-hero-layout">
              <div className="grc-hero-copy">
                <div className="grc-hero-eyebrow hero-eyebrow-tag mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-1.5 text-xs font-medium tracking-[0.14em] uppercase text-white/95 backdrop-blur-sm">
                ...
                <h1 className="flex flex-col pb-5 tracking-tight text-white">
                  <span className="whitespace-nowrap pb-2 text-[50px] leading-[1.08] font-light">
                    {hero.title}
                  </span>
                  <span className="mt-0.5 whitespace-nowrap text-[56px] leading-[1.08] font-bold">
                    {hero.titleHighlight}
                  </span>
                </h1>
