...
import { CiqHeroVisual } from "./CiqHeroVisual";
import "./ciq.css";
...
export function CiqHero() {
  return (
    <section className="aw-hero" aria-labelledby="ciq-hero-title">
      <motion.div
        ...
        <div className="aw-hero-body">
          <div className="aw-hero-banner-grid">
            <div className="aw-hero-copy">
              ...
              <h1 id="ciq-hero-title" className="aw-hero-title">
                <span className="aw-hero-title-line">{ciqHero.titleLine1}</span>
                <span className="aw-hero-title-line">{ciqHero.titleLine2}</span>
              </h1>

              <p className="aw-hero-desc">{ciqHero.description}</p>

              <div className="aw-hero-cta-row">
                <PillButton href="#ciq-capabilities" variant="orange" showArrow>
                  {ciqHero.primaryCta}
                </PillButton>
                <PillButton
                  href="#ciq-capabilities"
                  variant="white"
                  className="border border-[#e8e8e8] shadow-none hover:bg-white"
                >
                  {ciqHero.secondaryCta}
                </PillButton>
              </div>
            </div>
