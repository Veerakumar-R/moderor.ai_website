...
import { ciqChallenge } from "@/content/complianceIQ";
...
export function CiqBusinessChallenge() {
  const { tag, title, titleHighlight, paragraphs, visualBadge, visualClosing, bullets } = ciqChallenge;

  return (
    <section
      className="platform-why-section px-5 py-16 sm:px-[50px] sm:py-20 lg:py-24"
      aria-labelledby="ciq-challenge-heading"
    >
        ...
        <div className="platform-why-layout">
          ...
          <ScrollReveal duration={0.85} delay={0.1} className="platform-why-content-stack">
            <div className="platform-why-content-body">
              ...
              <h2 className="platform-why-headline" id="ciq-challenge-heading">
