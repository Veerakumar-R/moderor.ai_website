...
import { ciqFinalCta } from "@/content/complianceIQ";
...
export function CiqFinalCTA() {
  const descriptionLines = Array.isArray(ciqFinalCta.description)
    ? ciqFinalCta.description
    : [ciqFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="ciq-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="ciq-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{ciqFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {ciqFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
