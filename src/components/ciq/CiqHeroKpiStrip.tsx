...
import { ciqHero } from "@/content/complianceIQ";
...
export function CiqHeroKpiStrip() {
  const { kpiSection, kpis } = ciqHero;

  return (
    <div className="aw-hero-kpi-section" aria-label="Compliance IQ business outcomes">
