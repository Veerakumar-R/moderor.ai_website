...
import { ccmFinalCta } from "@/content/continuousComplianceMonitoring";
...
export function CcmFinalCTA() {
  const descriptionLines = Array.isArray(ccmFinalCta.description)
    ? ccmFinalCta.description
    : [ccmFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="ccm-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="ccm-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{ccmFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {ccmFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
