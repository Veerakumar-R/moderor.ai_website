...
import { CcmHeroVisual } from "./CcmHeroVisual";
import "./ccm.css";
...
export function CcmHero() {
  return (
    <section className="aw-hero" aria-labelledby="ccm-hero-title">
      <motion.div
        ...
        <div className="aw-hero-body">
          <div className="aw-hero-banner-grid">
            <div className="aw-hero-copy">
              ...
              <h1 id="ccm-hero-title" className="aw-hero-title">
                <span className="aw-hero-title-line">{ccmHero.titleLine1}</span>
                <span className="aw-hero-title-line">{ccmHero.titleLine2}</span>
              </h1>

              <p className="aw-hero-desc">{ccmHero.description}</p>

              <div className="aw-hero-cta-row">
                <PillButton href="#ccm-capabilities" variant="orange" showArrow>
                  {ccmHero.primaryCta}
                </PillButton>
                <PillButton
                  href="#ccm-capabilities"
                  variant="white"
                  className="border border-[#e8e8e8] shadow-none hover:bg-white"
                >
                  {ccmHero.secondaryCta}
                </PillButton>
              </div>
            </div>
