...
const WHY_CHOOSE_ICONS: LucideIcon[] = [Activity, Layers, Zap, ShieldCheck, Building2];
...
function WhyChooseCard({
  ...
  return (
    <motion.article
      className={`pilot-story-card pilot-story-card--${theme.variant} bom-why-choose-card`}
      style={
        {
    ...
    >
      ...
      <div className="bom-why-choose-card-inner">
        <div className="bom-why-choose-card-head">
          <div className="bom-why-choose-icon-panel" aria-hidden>
            <span className="bom-why-choose-icon-glow" />
            <Icon className="bom-why-choose-icon" strokeWidth={1.5} />
          </div>
        </div>

        <h3 className="bom-why-choose-title">{item.name}</h3>
        <p className="bom-why-choose-desc">{item.description}</p>
      </div>
    </motion.article>
  );
}

export function BomSuiteWhyChooseSection() {
  const reduceMotion = useReducedMotion();
  const rm = !!reduceMotion;

  return (
    <section
      id="why-choose-bom-suite"
      className="pilot-section bom-why-choose-section relative border-b border-border px-5 pt-20 pb-20 sm:px-[50px] sm:pt-24 sm:pb-24 lg:pt-28 lg:pb-28"
    >
      ...
      <div className="bom-section-inner relative z-[1]">
        ...
        <div className="bom-why-choose-grid">
