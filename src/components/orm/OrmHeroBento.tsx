...
import { Activity, Bot, MoreVertical, ShieldAlert, TrendingUp } from "lucide-react";
...
const KRI_RATES = LINE_MONTHS.map((m) => m.rate);
      ...
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <div>
            ...
            <p className="aw-stack-sub aw-stack-sub--accent">Risk identification</p>
          </div>
        </div>
        <CardMenu />
      </div>
      ...
      <div className="aw-stack-accent-body">
        <div className="aw-stack-ring aw-stack-ring--accent" aria-hidden>
          <svg viewBox="0 0 64 64">
            <defs>
              <linearGradient id="orm-accent-ring-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <div>
            <p className="aw-stack-kicker">RCM Risks</p>
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <div>
            <p className="aw-stack-kicker">KRI Health</p>
            <p className="aw-stack-sub">Threshold monitoring</p>
          </div>
        </div>
        <CardMenu />
      </div>
      ...
      <div className="aw-stack-rate-head">
        <p className="aw-stack-metric aw-stack-metric--sm">
          <Count to={KRI_RATES[focus]} decimals={1} />
          <span>%</span>
        </p>
        <div className="aw-stack-rate-stats">
          <span className="aw-stack-rate-pill aw-stack-rate-pill--done">34 within limits</span>
          <span className="aw-stack-rate-pill aw-stack-rate-pill--pending">6 breached</span>
        </div>
      </div>
      ...
      <div className="aw-stack-line-wrap aw-stack-line-wrap--rate" aria-hidden>
        <svg className="aw-stack-line-chart" viewBox={`0 0 ${w} ${h}`} preserveAspectRatio="none">
          <defs>
            <linearGradient id="orm-rate-area" x1="0" y1="0" x2="0" y2="1">
...
function MiniStatusCard({ reduceMotion }: { reduceMotion: boolean }) {
  const rows = [
    { id: "INC-2847", status: "Open", tone: "blue" },
    { id: "INC-2841", status: "Resolved", tone: "grey" },
  ];
    ...
    >
      <div className="aw-stack-card-top">
        <div className="aw-stack-hero-label">
          ...
          <p className="aw-stack-kicker">Live Incidents</p>
        </div>
        <CardMenu />
      </div>
