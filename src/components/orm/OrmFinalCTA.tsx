...
import { ormFinalCta } from "@/content/operationalRiskManagement";
...
export function OrmFinalCTA() {
  const descriptionLines = Array.isArray(ormFinalCta.description)
    ? ormFinalCta.description
    : [ormFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="orm-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="orm-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{ormFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {ormFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
