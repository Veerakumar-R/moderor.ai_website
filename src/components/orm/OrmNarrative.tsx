...
import { ormNarrative } from "@/content/operationalRiskManagement";
import { ScrollReveal } from "../ui/ScrollReveal";
import "@/components/human.css";
import "./orm.css";

export function OrmNarrative() {
  const { problem, solution, tagline, titleLead, titleHighlight, centerImage } = ormNarrative;
