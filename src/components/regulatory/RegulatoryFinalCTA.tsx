...
import { regulatoryFinalCta } from "@/content/regulatoryCompliance";
...
export function RegulatoryFinalCTA() {
  const descriptionLines = Array.isArray(regulatoryFinalCta.description)
    ? regulatoryFinalCta.description
    : [regulatoryFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="rc-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="rc-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{regulatoryFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {regulatoryFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
