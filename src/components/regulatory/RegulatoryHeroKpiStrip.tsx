...
export function RegulatoryHeroKpiStrip() {
  const { kpiSection, kpis } = regulatoryHero;

  return (
    <div className="aw-hero-kpi-section" aria-label="Regulatory Compliance business outcomes">
