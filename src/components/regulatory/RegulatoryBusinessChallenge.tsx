...
import { regulatoryChallenge } from "@/content/regulatoryCompliance";
...
export function RegulatoryBusinessChallenge() {
  const { tag, title, titleHighlight, paragraphs, visualBadge, visualTitle, bullets, closing } =
    regulatoryChallenge;

  return (
    <section
      className="platform-why-section px-5 py-16 sm:px-[50px] sm:py-20 lg:py-24"
      aria-labelledby="rc-challenge-heading"
    >
      <div className="grc-section-inner">
        <div className="platform-why-layout">
          <ScrollReveal duration={0.85} className="platform-why-visual-col">
            <PlatformWhyVisual title={visualTitle} bullets={bullets} badge={visualBadge} />
          </ScrollReveal>
          ...
          <ScrollReveal duration={0.85} delay={0.1} className="platform-why-content-stack">
            <div className="platform-why-content-body">
              ...
              <h2 className="platform-why-headline" id="rc-challenge-heading">
            ...
            <p className="platform-why-closing">{closing}</p>
          </ScrollReveal>
        </div>
      </div>
    </section>
