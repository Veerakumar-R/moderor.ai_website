...
import { satFinalCta } from "@/content/smartAlertTriage";
...
export function SatFinalCTA() {
  const descriptionLines = Array.isArray(satFinalCta.description)
    ? satFinalCta.description
    : [satFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="sat-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="sat-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{satFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {satFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
