...
import { satChallenge } from "@/content/smartAlertTriage";
...
export function SatBusinessChallenge() {
  const { tag, title, titleHighlight, paragraphs, visualBadge, visualClosing, bullets } = satChallenge;

  return (
    <section
      className="platform-why-section px-5 py-16 sm:px-[50px] sm:py-20 lg:py-24"
      aria-labelledby="sat-challenge-heading"
    >
        ...
        <div className="platform-why-layout">
          ...
          <ScrollReveal duration={0.85} delay={0.1} className="platform-why-content-stack">
            <div className="platform-why-content-body">
              ...
              <h2 className="platform-why-headline" id="sat-challenge-heading">
