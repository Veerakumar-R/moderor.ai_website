...
import { platformPage, siteConfig } from "@/content/site";
import { PillButton } from "@/components/ui/PillButton";
import { HeroCenterPattern } from "@/components/HeroCenterPattern";
import { PlatformHeroVisual } from "./PlatformHeroVisual";
import "@/components/grc-suite/grc-suite.css";
import "./platform.css";

const { hero } = platformPage;
          ...
          <div className="grc-section-inner w-full">
            <div className="grc-hero-layout">
              <div className="grc-hero-copy">
                ...
                <h1 className="flex flex-col pb-4 tracking-tight text-white">
                  <span className="pb-2 text-[44px] leading-[1.08] font-normal sm:text-[54px] lg:text-[60px]">
                    {hero.title}
                  </span>
                  <span className="mt-0.5 text-[44px] leading-[1.08] font-bold sm:text-[54px] lg:text-[60px]">
                    {hero.titleHighlight}
                  </span>
                </h1>
                ...
                <p className="grc-hero-description mt-4 max-w-2xl text-white/80">
                  {hero.tagline}
                </p>
