...
import { hrChallenge } from "@/content/hrCompliance";
...
export function HrBusinessChallenge() {
  ...
  return (
    <section
      ...
      aria-labelledby="hr-challenge-heading"
    >
        ...
        <div className="platform-why-layout">
          ...
          <ScrollReveal duration={0.85} delay={0.1} className="platform-why-content-stack">
            <div className="platform-why-content-body">
              ...
              <h2 className="platform-why-headline" id="hr-challenge-heading">
