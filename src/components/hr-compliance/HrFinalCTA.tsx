...
import { hrFinalCta } from "@/content/hrCompliance";
...
export function HrFinalCTA() {
  const descriptionLines = Array.isArray(hrFinalCta.description)
    ? hrFinalCta.description
    : [hrFinalCta.description];

  return (
    <section className="final-closing-section" aria-labelledby="hr-final-heading">
            ...
            <div className="final-closing-cta final-closing-cta--aside-action">
              <div className="final-closing-cta-top">
                <div className="final-closing-cta-lead">
                  <h2 id="hr-final-heading" className="final-closing-headline">
                    <span className="final-closing-headline-line">{hrFinalCta.titleLead}</span>
                    <span className="final-closing-headline-line final-closing-headline-accent text-accent-gradient">
                      {hrFinalCta.titleHighlight}
                    </span>
                  </h2>
                </div>
